...
class RiwayatTransferMenuAdapter(private val riwayatTransfers: List<RiwayatTransfer>) : RecyclerView.Adapter<RiwayatTransferMenuAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_riwayat_transfer_menu, parent, false)
